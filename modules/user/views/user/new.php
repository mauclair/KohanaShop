...
<form action="<?=url::site('user/add')?>" method="post" id="new-form" class="floating-labels">
    <div>
        
        <label for="name"><?= Kohana::lang('user.email')?></label>
        <input type="text" name="email" value="" id="email" class="required email"/><br />
        <label for="name"><?= Kohana::lang('user.name')?></label>
        <input type="text" name="name" value="" id="name" class="required"/><br />
